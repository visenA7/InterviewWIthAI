...
export default function History({
  ...
  const handleClearAll = () => {
    if (
      window.confirm(
        "Are you sure you want to permanently clear all past interview scores? This action cannot be undone.",
      )
    ) {
      clearHistory();
    }
  ...
  const handleDelete = (e, id) => {
    e.stopPropagation();
    if (
      window.confirm("Are you sure you want to delete this interview report?")
    ) {
      deleteInterview(id);
    }
  };
  ...
  return (
    <div className="history-container container animate-slide-up">
      <div className="history-header">
        ...
        <p>
          Review and track your skill progression across all past local training
          runs.
        </p>
      </div>
      ...
      <div className="history-body">
        {historyList.length === 0 ? (
          <div className="history-empty glass-panel">
            ...
            <p>
              Your finished sessions, scores, and custom feedback reports will
                ...
                <div className="item-meta">
                  ...
                  <div className="meta-details-row">
                    <span className="meta-detail">
                      Difficulty: <strong>{session.config.difficulty}</strong>
                    </span>
                    <span className="meta-detail-dot"></span>
                    <span className="meta-detail">
                      Questions: <strong>{session.config.numQuestions}</strong>
                    </span>
                  </div>
                </div>
                ...
                <div className="item-stats">
                  {session.status === "completed" && session.evaluation ? (
                    <div className="score-stat-display">
                      ...
                      <span
                        className={`score-badge-val ${getScoreColor(session.evaluation.overallScore)}`}
                      >
                  ...
                  <div className="action-buttons-group">
                    ...
                    <button
                      className="btn btn-danger btn-icon delete-session-btn"
                      title="Delete Report"
